...
class Config:
    ...
    def raw_data_path(self) -> str:
        return os.getenv(
            "RAW_DATA_PATH", self._config.get("paths", {}).get("raw_data", "data/raw")
        )

    @property
    def bronze_path(self) -> str:
        return os.getenv(
            "BRONZE_PATH", self._config.get("paths", {}).get("bronze", "data/bronze")
        )

    @property
    def silver_path(self) -> str:
        return os.getenv(
            "SILVER_PATH", self._config.get("paths", {}).get("silver", "data/silver")
        )

    @property
    def gold_path(self) -> str:
        return os.getenv(
            "GOLD_PATH", self._config.get("paths", {}).get("gold", "data/gold")
        )

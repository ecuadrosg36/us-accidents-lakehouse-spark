...
class SparkOptimizer:
    ...
    @staticmethod
    def apply_broadcast_join(large_df: DataFrame, small_df: DataFrame, join_col: str) -> DataFrame:
        """
    ...
    @staticmethod
    def optimize_partitions(df: DataFrame, target_partition_size_mb: int = 128) -> DataFrame:
        """
        ...
        logger.info(f"Repartitioning to {num_partitions} partitions (target: {target_partition_size_mb}MB)")
